...
export interface FunPost { _id: Id; caption?: string; imageUrl?: string; likeCount: number; liked: boolean; isOwner: boolean; createdAt: string; owner: { _id: Id; firstName: string; clubName?: string; photoUrl?: string }; }
