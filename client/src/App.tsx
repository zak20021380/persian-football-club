...
export default function App(){return <MembershipGate><Routes><Route element={<AppShell/>}><Route index element={<HomePage/>}/><Route path="competition" element={<CompetitionHubPage/>}/><Route path="matches" element={<MatchesPage/>}/><Route path="competitions" element={<CompetitionsPage/>}/><Route path="quiz" element={<QuizPage/>}/><Route path="rankings" element={<RankingsPage/>}/><Route path="rewards" element={<RewardsPage/>}/><Route path="club" element={<ClubPage/>}/><Route path="club/squad" element={<ClubFeaturePage slug="squad"/>}/><Route path="club/players" element={<ClubFeaturePage slug="players"/>}/><Route path="club/transfer-market" element={<ClubFeaturePage slug="transfer-market"/>}/><Route path="club/trade-offers" element={<ClubFeaturePage slug="trade-offers"/>}/><Route path="club/transactions" element={<ClubFeaturePage slug="transactions"/>}/><Route path="club/customization" element={<ClubFeaturePage slug="customization"/>}/><Route path="store" element={<StorePage/>}/><Route path="fun" element={<Suspense fallback={<PageSkeleton/>}><FunPage/></Suspense>}/><Route path="profile" element={<ProfilePage/>}/></Route><Route path="matches/:id" element={<MatchDetailPage/>}/><Route path="competitions/:id" element={<CompetitionDetailPage/>}/><Route path="admin" element={<AdminPage/>}/><Route path="admin/fun" element={<Suspense fallback={<PageSkeleton/>}><FunModerationPage/></Suspense>}/><Route path="404" element={<NotFoundPage/>}/><Route path="*" element={<Navigate to="/404" replace/>}/></Routes></MembershipGate>}
