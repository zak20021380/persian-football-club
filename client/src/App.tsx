...
export default function App(){return <MembershipGate><TelegramDeepLinkRouter/><Routes><Route element={<AppShell/>}><Route index element={<HomePage/>}/><Route path="competition" element={<CompetitionHubPage/>}/><Route path="matches" element={<MatchesPage/>}/><Route path="competitions" element={<CompetitionsPage/>}/><Route path="quiz" element={<QuizPage/>}/><Route path="rankings" element={<RankingsPage/>}/><Route path="rewards" element={<RewardsPage/>}/><Route path="club" element={<ClubPage/>}/><Route path="club/players" element={<PlayersPage/>}/><Route path="club/transfer-market" element={<TransferMarketPage/>}/><Route path="club/trade-offers" element={<TradeOffersPage/>}/><Route path="club/transactions" element={<ClubFeaturePage slug="transactions"/>}/><Route path="club/customization" element={<ClubFeaturePage slug="customization"/>}/><Route path="store" element={<StorePage/>}/><Route path="fun" element={<Suspense fallback={<PageSkeleton/>}><FunPage/></Suspense>}/><Route path="profile" element={<ProfilePage/>}/></Route><Route path="club/squad" element={<SquadPage/>}/><Route path="matches/:id" element={<MatchDetailPage/>}/><Route path="competitions/:id" element={<CompetitionDetailPage/>}/><Route path="admin" element={<AdminPage/>}/><Route path="admin/fantasy" element={<Suspense fallback={<PageSkeleton/>}><FantasyAdminPage/></Suspense>}/><Route path="admin/fun" element={<Suspense fallback={<PageSkeleton/>}><FunModerationPage/></Suspense>}/><Route path="404" element={<NotFoundPage/>}/><Route path="*" element={<Navigate to="/404" replace/>}/></Routes></MembershipGate>}
