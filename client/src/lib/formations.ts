...
export const formations: Record<BuiltInSquadFormation, FormationSlot[]> = {
  ...
  '3-5-2': [
    { role: 'GK', x: 50, y: 91 },
    { role: 'CB', x: 22, y: 74 }, { role: 'CB', x: 50, y: 78 }, { role: 'CB', x: 78, y: 74 },
    { role: 'LM', x: 10, y: 48 }, { role: 'CM', x: 30, y: 55 }, { role: 'DM', x: 50, y: 61 }, { role: 'CM', x: 70, y: 55 }, { role: 'RM', x: 90, y: 48 },
  ...
  '5-3-2': [
    { role: 'GK', x: 50, y: 91 },
    { role: 'LWB', x: 9, y: 68 }, { role: 'CB', x: 28, y: 77 }, { role: 'CB', x: 50, y: 80 }, { role: 'CB', x: 72, y: 77 }, { role: 'RWB', x: 91, y: 68 },
    { role: 'CM', x: 20, y: 48 }, { role: 'DM', x: 50, y: 57 }, { role: 'CM', x: 80, y: 48 },
    { role: 'ST', x: 35, y: 20 }, { role: 'ST', x: 65, y: 20 },
  ],
  '4-1-4-1': [
    { role: 'GK', x: 50, y: 91 },
    { role: 'LB', x: 12, y: 73 }, { role: 'CB', x: 37, y: 78 }, { role: 'CB', x: 63, y: 78 }, { role: 'RB', x: 88, y: 73 },
    { role: 'DM', x: 50, y: 61 },
    { role: 'LM', x: 12, y: 42 }, { role: 'CM', x: 37, y: 48 }, { role: 'CM', x: 63, y: 48 }, { role: 'RM', x: 88, y: 42 },
    { role: 'ST', x: 50, y: 16 },
  ],
};
