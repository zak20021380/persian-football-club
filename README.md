...
یک ربات فارسی تلگرام به‌همراه Mini App موبایل‌فرست برای کوییز، جام، پیش‌بینی مسابقه، رتبه‌بندی، جوایز، دعوت دوستان و تبلیغات اسپانسری. تمام محتوا و نتایج توسط مدیر ثبت می‌شوند و پروژه هیچ وابستگی‌ای به APIهای فوتبال یا لایو‌اسکور ندارد.
